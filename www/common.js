...
var Common = {
    ...
    Services: {
        url: {
            //Host: 'http://aba.smartlog.vn/',
            //SYS: 'http://aba.smartlog.vn/api/SYS/',
            //MOBI: 'http://aba.smartlog.vn/api/Mobile/',

            //Host: 'http://glc.smartlog.vn/',
            //SYS: 'http://glc.smartlog.vn/api/SYS/',
            //MOBI: 'http://glc.smartlog.vn/api/Mobile/',

            Host: 'http://tmsdemo.smartlog.vn/',
            SYS: 'http://tmsdemo.smartlog.vn/api/SYS/',
            MOBI: 'http://tmsdemo.smartlog.vn/api/Mobile/',
