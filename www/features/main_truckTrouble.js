app.controller('main_truckTroubleCtrl', function ($rootScope, $scope, $state, $location, $http, $timeout, $ionicLoading, $ionicSideMenuDelegate, $ionicModal) {
    console.log('main_truckTroubleCtrl');
