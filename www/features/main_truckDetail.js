app.controller('main_truckDetailCtrl', function ($rootScope, $scope, $state, $stateParams, $location, $http, $timeout, $ionicLoading, $ionicModal, $cordovaFileTransfer) {
    console.log('main_truckDetailCtrl');
