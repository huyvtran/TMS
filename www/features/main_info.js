app.controller('main_infoCtrl', function ($rootScope, $scope, $ionicLoading, $state, $location, $http, $timeout, $cordovaBarcodeScanner, $ionicPopup) {
    console.log('main_infoCtrl');
