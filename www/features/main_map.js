app.controller('main_mapCtrl', function ($rootScope, $scope, $state, $location, $http, $timeout, $ionicLoading, $ionicSideMenuDelegate, $ionicModal) {
    console.log('main_mapCtrl');
